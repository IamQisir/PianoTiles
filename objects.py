...
class Tile(pygame.sprite.Sprite):
    def __init__(self, x, y, win):
        ...
        # This is necessary to properly set up the sprite
        ...
        # pygame.Surface is for rendering images
        # pygame.SRCALPHA allows for transparency in the surface
        self.surface = pygame.Surface((TILE_WIDTH, TILE_HEIGHT), pygame.SRCALPHA)
        # get_rect() returns a rectangle object that has the same size as the surface
        ...
        self.line_end = self.center[0], self.center[1] - 40
    ...
    def update(self, speed):
        ...
        if self.alive:
            ...
            pygame.draw.rect(
                self.surface, (0, 0, 0, 90), (0, 0, TILE_WIDTH, TILE_HEIGHT)
            )
...
class Square(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        pygame.draw.rect(
            self.surface, (30, 144, 255, 128), (2, 2, self.side - 4, self.side - 4), 2
        )
